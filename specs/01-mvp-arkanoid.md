...
- Fixed canvas `800x600`. HTML HUD for score and lives. HTML overlays for Start, Win, and Lose.
...
- Window resize, touch/mobile layout, extra audio files.
...
- [ ] Canvas is `800x600`. HUD shows score and lives in HTML, not on the canvas.
...
- **No:** Pause, high scores, multiple levels, power-ups, resize, frameworks.
